...
public class TitleScreen {
	...
	public void show() {
		...
		do {
			selected = IO.readInt("Was moechtest du auswaehlen: ");
		...
		case 2: /* Einstellungen */
			...
			} while (settings.getChange() != 6); /*
													 * Führt die Einstellungen solange aus, solange der User die
													 * Einstellungen nicht verlässt (6 = Verlassen)
													 */
	...
	public void showBye() { /* Zeigt den Auf Wiedersehen Schriftzug */
		...
		System.out
				.println("    /  \\  _   _| |_   \\ \\  /\\  / / _  ___  __| | ___ _ __ ___  ___| |__   ___ _ __ | |");
		System.out.println(
				"   / /\\ \\| | | |  _|   \\ \\/  \\/ / | |/ _ \\/ _` |/ _ \\ '__/ __|/ _ \\ '_ \\ / _ \\ '_ \\| |");
		System.out
				.println("  / ____ \\ |_| | |      \\  /\\  /  | |  __/ (_| |  __/ |  \\__ \\  __/ | | |  __/ | | |_|");
		System.out.println(
				" /_/    \\_\\__,_|_|       \\/  \\/   |_|\\___|\\__,_|\\___|_|  |___/\\___|_| |_|\\___|_| |_(_)");
	}
